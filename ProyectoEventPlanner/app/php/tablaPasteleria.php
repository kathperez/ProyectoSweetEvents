Pastelerialass="table-bordeless" style="font-family: 'Raleway', serif;">
      ...
      $sql =  "SELECT * FROM `company` WHERE `idCompany` in (SELECT `idCompany` from `company_category` where `idCategory` = 2)";
      ...
      <tr>
        ...
        <td scope="col">
          <br>
                          ...
                          <a href="<?php echo $show[10]  ?>" class="fa fa-facebook-square fa-2x" style="color: #0a0a0a; float: right"></a>
                          </p>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Pasteleria/".$show[5] ?>" class="d-block w-100">
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Pasteleria/".$show[6] ?>" class="d-block w-100" >
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Pasteleria/".$show[7] ?>" class="d-block w-100" >
    </div>
  </div>
