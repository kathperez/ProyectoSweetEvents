...
<table class="table-bordeless" style="font-family: 'Raleway', serif;">
      ...
      $sql =  "SELECT * FROM `company` WHERE `idCompany` in (SELECT `idCompany` from `company_category` where `idCategory` = 3)";
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Banquetes/".$show[5] ?>" class="d-block w-100">
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Banquetes/".$show[6] ?>" class="d-block w-100" >
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Banquetes/".$show[7] ?>" class="d-block w-100" >
    </div>
  </div>
