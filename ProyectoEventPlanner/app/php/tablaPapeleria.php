...
<table class="table-bordeless" style="font-family: 'Raleway', serif;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Papeleria/".$show[5] ?>" class="d-block w-100">
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Papeleria/".$show[6] ?>" class="d-block w-100" >
    </div>
    <div class="carousel-item" style="height: 390px; width: 555px;">
      <img src="<?php echo "upload/Papeleria/".$show[7] ?>" class="d-block w-100" >
    </div>
  </div>
